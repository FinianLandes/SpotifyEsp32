...
- [NetworkClientSecure](https://github.com/espressif/arduino-esp32/tree/master/libraries/NetworkClientSecure) (Depending on Platform WifiClientSecure as NetworkClientSecure is not yet supported)</br>
